  ...
  return (
    <nav className='space-x-10'>
      <ul className='flex flex-row space-x-4 md:space-x-10 md:text-xl justify-center md:justify-end font-thin'>
        <li>
          <a href='#work' className='py-1 px-5 hover:bg-gray focus:bg-gray rounded-lg'>
            Work
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="./veeralResume.pdf"
            target="_blank" rel='noreferrer' className='py-1 px-5 hover:bg-gray focus:bg-gray rounded-lg'>
            Resume
          </a>
        </li>
      </ul>

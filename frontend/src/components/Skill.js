  ...
  return (
    <section className='my-28  px-5'>
      ...
      <div className='my-7 grid gap-5 grid-cols-3 md:grid-cols-6'>
        ...
        <div class="flex flex-col items-center" tabindex="0" role="img" aria-label="CSS 3"><img src="./images/icons/mysql.svg" alt="" class="w-16 mb-1" width="64px" height="64px" />MySQL</div>
        <div class="flex flex-col items-center" tabindex="0" role="img" aria-label="HTML 5"><img src="./images/icons/git-icon.svg" alt="" class="w-16 mb-1" width="64px" height="64px" />Git</div>
        <div class="flex flex-col items-center" tabindex="0" role="img" aria-label="CSS 3"><img src="./images/icons/java.svg" alt="" class="w-16 mb-1" width="64px" height="64px" />Java</div>
      </div>
    </section>
  );
};
